...
import { RegisterSchema, RegisterSchemaType } from "@/lib/schema/RegisterSchems"
import { LuLoader2 } from "react-icons/lu"
import Register from "@/actions/Auth/register"
import SuccessToast from "@/components/Global/SuccessToast"
import { GetUserByEmail, GetUserByUsername } from "@/actions/Data/User/GET"
import Link from "next/link"
import { Toaster } from "react-hot-toast"
import Image from "next/image"
import { motion, AnimatePresence } from "framer-motion"
import { computeSha256 } from "@/lib/cryptography"
import { getSignedUrlUnauthenticated } from "@/actions/AWS/ProfilePicUpload"
import { PROFILE_PIC_ALLOWED_FILE_TYPES, PROFILE_PIC_MAX_FILE_SIZE } from "../../../../metadata"
import ImageCropper from "../Register/ImageCropper"
        ...
        <form onSubmit={handleSubmit(handleSignUp)} >
            <Card className="w-full max-w-sm my-6 bg-dark-bg text-primary border-none ">
                ...
                <CardFooter className="flex flex-col">
                    ...
                    >
                        {isLoading ? <LuLoader2 className="animate-spin" /> : "Register"}
                    </Button>
